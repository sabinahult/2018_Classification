...
import enums.*;
/**
 * The data.DataManager class is used to convert the string data loaded in from the text file
 * to data.Mushroom objects.
 * The data.DataManager class makes use of the data.CSVFileReader class to accomplish this.
 *
 */
public class DataManager {
	 ...
	 * @return
	 */
	public static int CountClassInstancesBasedOnAttributeValue(List<Mushroom> Data, Object Attribute, Object AttributeValue, Object Classification)
	{	
		int count = 0;
